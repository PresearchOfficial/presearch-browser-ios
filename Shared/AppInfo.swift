...
open class AppInfo {
  ...
  public static var sharedContainerIdentifier: String {
    ...
    // External beta
    if bundleIdentifier == "com.Presearch.BrowseriOS.beta" {
      // com.brave.ios.BrowserBeta is taken and can't be used as an app group.
      bundleIdentifier = "com.Presearch.BrowseriOS.beta.unique"
    }
  ...
  public static func keychainAccessGroupWithPrefix(_ prefix: String) -> String {
    var bundleIdentifier = baseBundleIdentifier
    if bundleIdentifier == "com.presearch.BrowseriOS.FennecEnterprise" {
      ...
      bundleIdentifier = "com.presearch.BrowseriOS.Fennec.enterprise"
    }
