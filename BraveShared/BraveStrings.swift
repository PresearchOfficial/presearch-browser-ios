...
extension Strings {
    ...
    public static let OBSearchEngineTitle = NSLocalizedString("OBSearchEngineTitle", bundle: Bundle.braveShared, value: "Presearch Privacy Browser", comment: "Title for search engine onboarding screen")
    public static let OBSearchEngineDetail = NSLocalizedString("OBSearchEngineDetail", bundle: Bundle.braveShared, value: "\n Presearch is a privacy-focused, decentralized search engine.\n\n Search privately, receive better results and get rewarded, powered by blockchain technology.\n\n Built by the community, for the community.", comment: "Detail text for search engine onboarding screen")
...
extension Strings {
    public struct Popover {
        ...
        public static let closeShieldsMenu = NSLocalizedString("PopoverShieldsMenuClose", bundle: Bundle.braveShared, value: "Close Shields Menu", comment: "Description for closing the `Presearch Ad Blocker` popover menu that is displayed.")
    }
}
    ...
    public struct ShieldEducation {
        ...
        public static let trackerAdCountBlockSubtitle =
            NSLocalizedString("shieldEducation.trackerAdCountBlockSubtitle",
                              bundle: .braveShared,
                              value: "Presearch Ad Blocker protects your online privacy on every site.",
        ...
        public static let shareDescriptionTitle = NSLocalizedString(
            ...
            comment: "Text used shile sharing Presearch Ad Blocker values")
    }
}
