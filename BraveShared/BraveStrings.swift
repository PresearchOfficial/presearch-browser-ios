...
extension Strings {
  public static let sendCrashReportAlertTitle = NSLocalizedString("SendCrashReportAlertTitle", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Oops! crashed", comment: "Title for prompt displayed to user after the app crashes")
  public static let sendCrashReportAlertMessage = NSLocalizedString("SendCrashReportAlertMessage", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Send a crash report so can fix the problem?", comment: "Message displayed in the crash dialog above the buttons used to select when sending reports")
  ...
  public static let restoreTabOnCrashAlertMessage = NSLocalizedString("RestoreTabOnCrashAlertMessage", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Looks like crashed previously. Would you like to restore your tabs?", comment: "Restore Tabs Prompt Description")
...
extension Strings {
  ...
  public static let accessPhotoDeniedAlertTitle = NSLocalizedString("AccessPhotoDeniedAlertTitle", tableName: "BraveShared", bundle: Bundle.braveShared, value: "would like to access your Photos", comment: "See http://mzl.la/1G7uHo7")
  ...
  public struct DefaultBrowserCallout {
    public static let introPrimaryText =
      NSLocalizedString(
        ...
        value: "Open all links with to protect your privacy",
    ...
    public static let notificationTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared", bundle: .braveShared,
        value: "Web Browser",
        comment: "Notification title to promote setting app as default browser")

    public static let notificationBody =
      NSLocalizedString(
        "defaultBrowserCallout.notificationBody",
        tableName: "BraveShared", bundle: .braveShared,
        value: "Optimized for iOS %@. Make your default browser today.",
        comment: "Notification body to promote setting app as default browser")
  }
}
  ...
  public struct Callout {
    public static let defaultBrowserCalloutTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared", bundle: .braveShared,
        value: "Make your default browser",
    ...
    public static let defaultBrowserCalloutDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared", bundle: .braveShared,
        value: "With as default, every link you click opens with Presearch's privacy protections.",
    ...
    public static let privacyEverywhereCalloutDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared", bundle: .braveShared,
        value: "Get privacy on your computer or tablet, and sync bookmarks & extensions between devices.",
  ...
  public struct Onboarding {
    ...
    public static let blockedAdsOnboardingPopoverSingleTrackerDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared", bundle: .braveShared,
        value: "blocked %@ and %d other tracker on: %@.",
    ...
    public static let blockedAdsOnboardingPopoverMultipleTrackerDescription =
      NSLocalizedString(
        ...
        tableName: "BraveShared", bundle: .braveShared,
        value: "blocked %@ and %d other trackers on: %@.",
        comment: "The description of the popover showing trackers that were blocked. %@ and %d are placeholders for a tracker name and count.")
...
extension Strings {
  public static let readerModeLoadingContentDisplayText = NSLocalizedString("ReaderModeLoadingContentDisplayText", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Loading content…", comment: "Message displayed when the reader mode page is loading. This message will appear only when sharing to reader mode from another app.")
  public static let readerModePageCantShowDisplayText = NSLocalizedString("ReaderModePageCantShowDisplayText", tableName: "BraveShared", bundle: Bundle.braveShared, value: "The page could not be displayed in Reader View.", comment: "Message displayed when the reader mode page could not be loaded. This message will appear only when sharing to reader mode from another app.")
  public static let readerModeLoadOriginalLinkText = NSLocalizedString("ReaderModeLoadOriginalLinkText", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Load original page", comment: "Link for going to the non-reader page when the reader view could not be loaded. This message will appear only when sharing to reader mode from another app.")
...
extension Strings {
  public struct OptionsMenu {
    ...
    public static let braveNewsItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item News")
    ...
    public static let bravePlaylistItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item Playlist")
    public static let braveWalletItemDescription = NSLocalizedString(
      ...
      comment: "The subtitle description of menu item Wallet")
  }
}
...
extension Strings {
  ...
  public static let braveRewardsTitle = NSLocalizedString("BraveRewardsTitle", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Rewards", comment: "Rewards settings title")
  public static let hideRewardsIcon = NSLocalizedString("HideRewardsIcon", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Hide Rewards Icon", comment: "Hides the rewards icon")
  public static let hideRewardsIconSubtitle = NSLocalizedString("HideRewardsIconSubtitle", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Hides the Rewards icon when Rewards is not enabled", comment: "Hide the rewards icon explination.")
  ...
  public static let openBraveRewardsSettings = NSLocalizedString("OpenBraveRewardsSettings", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Open Rewards Settings", comment: "Button title for opening the Rewards panel to settings")
  public static let setDefaultBrowserSettingsCell =
    NSLocalizedString("setDefaultBrowserSettingsCell", tableName: "BraveShared", bundle: .braveShared, value: "Set as Default Browser", comment: "Settings item to set the as a default browser on the iOS device.")
  public static let setDefaultBrowserCalloutTitle =
    NSLocalizedString(
      "setDefaultBrowserCalloutTitle", tableName: "BraveShared", bundle: .braveShared,
      value: "can now be set as your default browser in iOS. Tap here to open settings.", comment: "")
  ...
  public struct Settings {
    ...
    public static let autocloseTabsSettingFooter =
      NSLocalizedString(
        ...
        bundle: .braveShared, value: "Allow to automatically close tabs that haven't recently been viewed.",
...
extension Strings {
  ...
  public static let braveSyncWelcome = NSLocalizedString("BraveSyncWelcome", tableName: "BraveShared", bundle: Bundle.braveShared, value: "To start, you will need installed on all the devices you plan to sync. To chain them together, start a sync chain that you will use to securely link all of your devices together.", comment: "Sync settings welcome")
  ...
  public static let syncToDeviceDescription = NSLocalizedString("SyncToDeviceDescription", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Using existing synced device open Settings and navigate to Settings -> Sync. Choose \"Add Device\" and scan the code displayed on the screen.", comment: "Sync to existing device description")
  ...
  public static let syncNewerVersionError = NSLocalizedString("syncNewerVersionError", tableName: "BraveShared", bundle: Bundle.braveShared, value: "This sync code was generated by a newer version of on another device. Please update on all synced devices and try again.", comment: "Sync Error Description")
  public static let syncInsecureVersionError = NSLocalizedString("syncInsecureVersionError", tableName: "BraveShared", bundle: Bundle.braveShared, value: "This sync code was generated by an outdated version of on another device. Please update on all synced devices and try again.", comment: "Sync Error Description")
...
extension Strings {
  ...
  public static let browserLockDescription = NSLocalizedString("BrowserLockDescription", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Unlock with Touch ID, Face ID or system passcode.", comment: "")
  ...
  public static let searchWithBrave = NSLocalizedString("SearchWithBrave", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Search with Presearch", comment: "Title of an action that allows user to perform a one-click web search for selected text")
...
extension Strings {
  ...
  public static let versionTemplate = NSLocalizedString("VersionTemplate", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Version %@ (%@)", comment: "Version number of shown in settings")
  ...
  // End
  public static let privacyPolicy = NSLocalizedString("PrivacyPolicy", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Privacy Policy", comment: "Show Browser Privacy Policy page from the Privacy section in the settings.")
  public static let termsOfUse = NSLocalizedString("TermsOfUse", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Terms of Use", comment: "Show Browser TOS page from the Privacy section in the settings.")
  ...
  public static let bravePanel = NSLocalizedString("BravePanel", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Panel", comment: "Button to show the Presearch panel")
  ...
  public static let openExternalAppURLAllow = NSLocalizedString("ExternalAppURLAllow", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Allow", comment: "Allow to open the external app URL")
  public static let openExternalAppURLDontAllow = NSLocalizedString("ExternalAppURLDontAllow", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Don't Allow", comment: "Don't allow to open the external app URL")
  ...
  public static let defaultThemeName =
    NSLocalizedString(
      ...
      value: "default",
      comment: "Name for default theme.")
...
extension Strings {
  ...
  public static let OBJoinButton = NSLocalizedString("OBJoinButton", bundle: Bundle.braveShared, value: "Join", comment: "Button to join Rewards.")
  ...
  public static let OBRewardsDetail = NSLocalizedString("OBRewardsDetail", bundle: Bundle.braveShared, value: "Opting into Private Ads supports publishers and content creators with every ad viewed.", comment: "Detail text for rewards onboarding screen")
  public static let OBRewardsAgreementTitle = NSLocalizedString("OBRewardsAgreementTitle", bundle: Bundle.braveShared, value: "Rewards", comment: "Title for rewards agreement onboarding screen")
  ...
  public static let OBAdsTitle = NSLocalizedString("OBAdsTitle", bundle: Bundle.braveShared, value: "will show your first ad in", comment: "Title for ads onboarding screen")
  ...
  public static let OBPrivacyConsentDetail = NSLocalizedString("OBPrivacyConsentDetail", bundle: .braveShared, value: "You may have downloaded in support of your referrer. To detect your referrer, performs a one-time check of your clipboard for the matching referral code. This check is limited to the code only and no other personal data will be transmitted.  If you opt out, your referrer won’t receive rewards from Presearch.", comment: "")
  public static let OBPrivacyConsentClipboardPermission = NSLocalizedString("OBPrivacyConsentClipboardPermission", bundle: .braveShared, value: "Allow to check my clipboard for a matching referral code", comment: "")
...
extension Strings {
  public static let monthlyAdsClaimNotificationTitle = NSLocalizedString("MonthlyAdsClaimNotificationTitle", bundle: Bundle.braveShared, value: "Rewards 💵🎁", comment: "The title of the notification that goes out monthly to users who can claim an ads grant")
  ...
  public struct NTP {
    ...
    public static let learnMoreAboutRewards =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .braveShared,
        value: "Learn more about Rewards",
        comment: "")
    ...
    public static let braveSupportFavoriteTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .braveShared,
        value: "Presearch Docs",
        comment: "Bookmark title for Presearch doc")
...
extension Strings {
  public struct Shields {
    ...
    public static let globalChangeButton = NSLocalizedString("BraveShieldsGlobalChangeButton", bundle: Bundle.braveShared, value: "Change global Presearch Ad Blocker defaults", comment: "")
  ...
  public struct PlayList {
    ...
    public static let urlBarButtonOptionFooter =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Adds a playlist button (it looks like 4 lines with a + symbol) beside the address bar in the browser. This button gives you quick access to open Playlist, or add or remove media.",
    ...
    public static let menuBadgeOptionFooterText =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "When enabled, a badge will be displayed on the main menu icon, indicating media on the page may be added to Playlist.",
    ...
    public static let playlistPopoverAddTitle =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Would you like to add this media to your Playlist?",
    ...
    public static let playlistPopoverAddBody =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Playlists support Offline Playback, Picture-in-picture, continuous playback and repeat modes.",
    ...
    public static let playlistPopoverAddedTitle =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "This media is in your Playlist",
  ...
  public struct PlaylistFolders {
    ...
    public static let playlistFolderMoveItemDescription =
      NSLocalizedString(
        ...
        comment: "%@ Should NOT be localized. It is a placeholder. Example: Folder and 1 more item.")
    ...
    public static let playlistFolderMoveMultipleItemDescription =
      NSLocalizedString(
        ...
        comment: "%@ and %lld Should NOT be localized. They are placeholders. Example: Folder and 3 more items. Music and 2 more items.")
  ...
  public struct CertificateViewer {
    ...
    public static let organizationTitle =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Organization",
        comment: "Title of the section for Name of the Company. Example: Inc.")
  ...
  public struct Shortcuts {
    ...
    public static let activityTypeEnableVPNTitle =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Open Browser and Enable VPN",
        comment: "")
    ...
    public static let activityTypeTabDescription =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Start Searching the Web Securely with Presearch",
        comment: "")
    ...
    public static let activityTypeBraveNewsDescription =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Open News and Check Today's Top Stories",
        comment: "")
    ...
    public static let shortcutSettingsEnableVPNDescription =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Use Shortcuts to enable VPN via Siri - Voice Assistant",
        comment: "")
    ...
    public static let shortcutSettingsOpenBraveNewsDescription =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Use Shortcuts to open a new tab & show News Feed via Siri - Voice Assistant",
        comment: "Description of Open News Siri Shortcut in Settings Screen")
    ...
    public static let shortcutOpenApplicationSettingsDescription =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "This option will open Settings. In order to change various Siri options, please select 'Siri & Search' menu item and customize your choices.",
        comment: "Description for opening Settings for altering Siri shortcut.")
  }
}
  ...
  public struct VPN {
    ...
    public static let checkboxBlockAds =
      NSLocalizedString(
        ...
        comment: "Text for a checkbox to present the user benefits for using VPN")
    ...
    public static let installProfileTitle =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "will now install a VPN profile.",
        comment: "")
    ...
    public static let enableButton =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Enable",
        comment: "Button text to enable VPN")
    ...
    public static let buyButton =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Buy",
        comment: "Button text to buy VPN")
    ...
    public static let tryForFreeButton =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Try for FREE",
        comment: "Button text to try free VPN")
    ...
    public static let vpnConfigPermissionDeniedErrorBody =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "The Firewall + VPN requires a VPN profile to be installed on your device to work. ",
        comment: "Title for an alert when the user didn't allow to install VPN profile")
    ...
    public static let vpnResetAlertBody =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "This will reset your Firewall + VPN configuration and fix any errors. This process may take a minute.",
    ...
    public static let vpnBackgroundNotificationBody =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "Even in the background, will continue to protect you.",
        comment: "Notification title to tell user that the vpn is turned on even in background")
  ...
  public struct Sync {
    public static let syncV1DeprecationText =
      NSLocalizedString(
        ...
        bundle: .braveShared,
        value: "A new Sync is coming and will affect your setup. Get ready for the upgrade.",
        comment: "Text that informs a user about Sync service deprecation.")
    ...
    public static let v2MigrationMessage =
      NSLocalizedString(
        ...
        value: "In order to use Sync your existing bookmarks must be migrated to use the new system. This operation will not delete your bookmarks.",
...
extension Strings {
  public struct BraveNews {
    ...
    public static let introCardBody = NSLocalizedString(
      "today.introCardBody",
      bundle: .braveShared,
      value: "News is ad-supported with completely private and anonymized ads matched on your device.",
      comment: ""
    )
    ...
    public static let errorGeneralBody = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "News is experiencing some issues. Try again.",
      comment: ""
    )
    public static let disablePublisherContent = NSLocalizedString(
      ...
      comment: "'%@' will turn into the name of a publisher (verbatim), for example: Blog"
    )
    ...
    public static let disabledAlertBody = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "News will stop showing content from %@",
      comment: "'%@' will turn into the name of a publisher (verbatim), for example: Blog"
    )
    ...
    public static let moreBraveOffers = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "More Offers",
      comment: "'Offers' is a product name"
    )
...
extension Strings {
  public struct RewardsInternals {
    public static let title = NSLocalizedString("RewardsInternalsTitle", bundle: Bundle.braveShared, value: "Rewards Internals", comment: "'Rewards' as in 'Rewards'")
    ...
    public static let contributionProcessorBraveTokens = NSLocalizedString("RewardsInternalsContributionProcessorBraveTokens", bundle: Bundle.braveShared, value: "Tokens", comment: "")
    ...
    public static let shareInternalsTitle = NSLocalizedString("RewardsInternalsShareInternalsTitle", bundle: Bundle.braveShared, value: "Share Rewards Internals", comment: "'Rewards' as in 'Rewards'")
...
extension Strings {
  public struct Rewards {
    ...
    public static let disabledStatusBody = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Using Rewards helps support content creators as you browse.",
    ...
    public static let walletTransferFailureAlertMessage = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "The Rewards server did not respond. Please try again in a moment.",
    ...
    public static let walletTransferStepsBody = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Your Rewards token balance can be transfered to an existing Rewards desktop wallet, one time.\n\n1. Open Browser on your desktop\n2. Navigate to brave://rewards\n3. Click “QR Code”\n4. Scan QR Code with your device",
    ...
    public static let walletTransferCompleteBody = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Your transfer has initiated. Any existing BAT balance may take several minutes to appear in your desktop Rewards wallet. Check your Rewards summary on Desktop for details when transfer has completed.\n\nYou may close this window and continue using as your transfer is in progress.",
    ...
    public static let settingsToggleTitle = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Enable Rewards",
      comment: ""
    )
    public static let settingsToggleMessage = NSLocalizedString(
      "rewards.settingsToggleMessage",
      bundle: .braveShared,
      value: "Support content creators and publishers automatically by enabling Private Ads. Private Ads are privacy-respecting ads that give back to content creators.",
      comment: ""
    )
    public static let settingsFooterMessage = NSLocalizedString(
      "rewards.settingsFooterMessage",
      bundle: .braveShared,
      value: "Rewards payouts are temporarily unavailable on this device. Transfer your existing wallet funds to a desktop wallet to keep your tokens.",
      comment: ""
    )
    ...
    public static let legacyWalletTransferStatusCompletedBody = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Your legacy wallet transfer is done! Your existing balance may still take several minutes to appear on your desktop Rewards wallet.",
      comment: ""
    )
    ...
    public static let braveTalkRewardsOptInTitle =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .braveShared,
        value: "To start a free call, turn on Rewards",
        comment: "Title for Talk rewards opt-in screen")
    ...
    public static let braveTalkRewardsOptInBody =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .braveShared,
        value: "With Rewards, you can view privacy-preserving ads from the Ads network. No trackers. No slowdowns. And your data stays totally safe.",
        comment: "Body for Talk rewards opt-in screen")
    ...
    public static let braveTalkRewardsOptInButtonTitle =
      NSLocalizedString(
        ...
        comment: "Title for Talk rewards opt-in screen button")
    ...
    public static let braveTalkRewardsOptInSuccessTitle =
      NSLocalizedString(
        ...
        comment: "Title for successful Talk rewards opt-in")
    ...
    public static let braveTalkRewardsOptInSuccessBody =
      NSLocalizedString(
        ...
        tableName: "BraveShared",
        bundle: .braveShared,
        value: "Click anywhere on the screen to continue to Talk.",
        comment: "Body for successful Talk rewards opt-in")
  }
}
...
extension Strings {
  public struct Ads {
    public static let myFirstAdTitle = NSLocalizedString("MyFirstAdTitle", bundle: .braveShared, value: "This is your first ad", comment: "")
    ...
    public static let adNotificationTitle = NSLocalizedString("BraveRewardsAdNotificationTitle", bundle: .braveShared, value: "Rewards", comment: "")
  }
}
...
extension Strings {
  public struct Widgets {
    public static let noFavoritesFound = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Please open to view your favorites here",
    ...
    public static let shortcutsWidgetDescription = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Quick access to search the web or open web pages in Presearch.",
...
extension Strings {
  public struct PrivacyHub {
    public static let privacyReportsTitle = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Privacy Hub",
      comment: "Title of main privacy hub screen. This screen shows various stats caught by Presearch's ad blockers."
    )
    ...
    public static let allVPNAlertsButtonText = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "All alerts",
      comment: "Text for a button to display a list of all alerts caught by the VPN. VPN alert is a notificaion of what item has been blocked by the vpn, similar to a regular adblocker"
    )
    ...
    public static let allTimeListsTrackersView = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Trackers & ads",
      comment: "Title of a section to show total count of trackers blocked by Presearch"
    )
    ...
    public static let vpnLabel = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "Firewall + VPN",
      comment: "This label says about VPN, as a source of by what the resource was blocked by. Think of it in context of 'Blocked by VPN'"
    )
    ...
    public static let notificationMessage = NSLocalizedString(
      ...
      bundle: .braveShared,
      value: "A recap of how protected you online this week.",
    ...
    public static let settingsEnableVPNAlertsTitle = NSLocalizedString(
      ...
      comment: "Title of a setting that lets monitor blocked network requests captured by VPN"
    )
    ...
    public static let settingsEnableVPNAlertsFooter = NSLocalizedString(
      ...
      comment: "This text explains a setting that lets monitor blocked network requests captured by VPN"
    )
