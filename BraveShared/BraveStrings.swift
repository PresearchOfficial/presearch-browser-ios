...
extension Strings {
  ...
  public static let bravePanel = NSLocalizedString("BravePanel", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Panel", comment: "Button to show the brave panel")
...
extension Strings {
  ...
  public static let OBAdsOptInTitle = NSLocalizedString("OBAdsOptInTitle", bundle: Bundle.braveShared, value: "Ads is here!", comment: "Title when opting into brave Ads when region becomes available")
